...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 13 nov. 2024 à 18:05
...
INSERT INTO `joueurs` (`id`, `pseudo`, `rang`, `argent`, `set_ligue`, `progress_set`, `avatar_url`) VALUES
(1, 'PlayerOne', 'Bronze', 150, 1, 0, 'https://example.com/avatar1.png'),
(2, 'PlayerTwo', 'Silver', 300, 1, 0, 'https://example.com/avatar2.png'),
(3, 'PlayerThree', 'Gold', 500, 2, 0, 'https://example.com/avatar3.png'),
(4, 'PlayerFour', 'Platinum', 750, 2, 0, 'https://example.com/avatar4.png'),
(5, 'PlayerFive', 'Diamond', 1000, 3, 0, 'https://example.com/avatar5.png'),
